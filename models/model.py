...
from main.models.attention import MultiScaleBlock
from main.models.common import round_width
from main.utils.misc import validate_checkpoint_wrapper_import
...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        num_patches = reduce(operator.mul, patch_dims, 1)
